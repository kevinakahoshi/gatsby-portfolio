...
const SEO = ({ location, children }) => {
  const {
    metadata: { siteDescription, siteFavicon, siteOGImage, siteTitle, siteUrl },
    site: {
      siteMetadata: { title, url, description },
    },
  ...
  return (
    <Helmet>
      ...
      <meta
        ...
        key="ogdescription"
      />
      <body className={noScrollClass}>{children}</body>
    </Helmet>
  );
};
